...
class TestTryAhmia:
    ...
    def test_parses_redirect_url_from_ahmia_wrapper(self):
        ...
        with patch("httpx.Client") as MockClient:
            mock_ahm = MockClient.return_value.__enter__.return_value
            mock_ahm.get.side_effect = [home_resp, search_resp]
    ...
    def test_returns_empty_list_when_http_raises(self):
        ...
        with patch("httpx.Client") as MockClient:
            mock_ahm = MockClient.return_value.__enter__.return_value
            mock_ahm.get.side_effect = httpx.ConnectError("timeout")
